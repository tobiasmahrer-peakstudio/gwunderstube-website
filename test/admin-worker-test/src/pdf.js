...
export async function buildBookingDocumentPdf(stay, settings) {
  ...
  const agbText = `Der Gast hat am ${agbDate} mit dem Absenden der Buchungsanfrage die Allgemeinen Geschäftsbedingungen (AGB) akzeptiert und den oben genannten Zeitraum verbindlich angefragt. Mit der Bestätigung durch die Vermieterin ist der Mietvertrag zu den hier aufgeführten Bedingungen zustande gekommen. Eine separate Unterschrift ist nicht erforderlich.`;
